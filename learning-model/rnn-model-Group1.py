...
def readData(target_stock_name, column='data', n=5, all_too=True, index=False, train_end=-300):
    ...
    drop_subset = ['confidence', 'negative_prob', 'positive_prob', 'sentiment','stock','closing price','highest price','lowest price','opening price','before closing','turnover volume','turnover','total market capitalization','circulation market value']
...
def rnn_model(i):
    ...
    torch.save(rnn.state_dict(),
               '/Users/dingfan/Desktop/PyCharmProject/learning-model/trained_model_group1/' + target_stock_name + 'rnn.pkl')
