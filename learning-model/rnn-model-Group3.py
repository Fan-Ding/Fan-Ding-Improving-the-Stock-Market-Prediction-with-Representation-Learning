...
def get_correlation_stock_data(target_stock_name):
    ...
    target_stock_pd=pd.read_csv('/Users/dingfan/Desktop/PyCharmProject/learning-model/correlation_stock_data/'+target_stock_name+'correlation.csv',index_col=0)
...
def rnn_model(i):
    ...
    torch.save(rnn.state_dict(),
                '/Users/dingfan/Desktop/PyCharmProject/learning-model/trained_model_group3/' + target_stock_name + 'rnn.pkl')
    ...
    with open('trained-result-group3', 'a')  as file_object:
        file_object.write(target_stock_name + " accuracy: " + str(acc) + " F1: " + str(F1) + " "+ str(TP)+ " "+ str(TN) + " "+ str(FN) + " "+ str(FP) + " "+ str(TP + TN + FP + FN)  +'\n')
